...
const Section8 = () => {
  const sectionRef = useScrollReveal({ y: 48, stagger: 0.12 });
    ...
    <section className="section8" id="contact" ref={sectionRef}>
      <div className="section8-content">
        <div className="section8-left">
          <p className="section8-subtitle" data-reveal>
            READY TO GET STARTED?
          </p>
          <h2 className="section8-title" data-reveal>
            Let us engineer the right protection system for your machine
          </h2>
          <p className="section8-description" data-reveal>
          ...
          <div className="section8-contact-info" data-reveal>
        ...
        <div className="section8-right" data-reveal>
